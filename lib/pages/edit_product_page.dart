...
class _EditProductPageState extends State<EditProductPage> {
  ...
  List<DropdownMenuItem<ListProductType>> createDropdownMenu(
    ...
    var url = Uri.parse(
        'https://laravel-backendit-128.herokuapp.com/api/products/${widget.id}');
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            var ind =dropdownItems.indexWhere((Element) => Element.value == payload['product_type']);
  ...
  Future<void> updateProduct() async {
    ...
    if (_editFormKey.currentState!.validate()){
      ...
      var url = Uri.parse('https://laravel-backendit-128.herokuapp.com/api/products/${widget.id}');
